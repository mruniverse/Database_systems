...
INSERT INTO Associado (id_associado, nome, cpf, email, telefone, endereco)
	VALUES (1, 'Raimundo Bento Melo', '794.276.870-88', 'raimundobentomelo_@saae.sp', '79981836229', 'Rua A'),
		   (2, 'Marcelo César Carlos', '275.647.930-66', 'marcelocesarcarloseduardoalmada-90@engemed.com.br',
			'85997214310', 'Rua Pedro Artur'),
		   (3, 'Gustavo João Barbosa', '056.270.681-08', 'ggustavojoaobarbosa@prestec.com', '85987665053',
			'Parque Gavião'),
		   (4, 'Nina Tatiane Gonçalves', '777.442.506-30', 'ninatatianegoncalves_@embraer.com', '81981894960',
			'Rua José Targino de Castro'),
		   (5, 'Carlos Thales Alexandre', '703.608.568-10',
			'carlosthalesalexandreferreira__carlosthalesalexandreferreira@editorazap.com', '82985934214',
			'Rua Nelson de Azevedo Souza'),
		   (6, 'Pedro Ricardo Samuel', '538.463.777-32', 'pedroricardosamuelsales__pedroricardosamuelsales@prlme.com',
			'79987640552', 'Rua C'),
		   (7, 'Nicolas César Farias', '689.330.892-25', 'nicolascesarfarias__nicolascesarfarias@db4.com',
			'83984762910', 'Rua Jânio Lopes'),
		   (8, 'Vitória Joana Peixoto', '107.827.938-19', 'vitoriajoanapeixoto-70@redacaofinal.com.br', '11985518314',
			'Alameda das Serras'),
		   (9, 'Bryan Calebe Diego', '875.494.708-12', 'bryancalebediegoassis_@alcastro.com', '55987323219',
			'Rua Professora Hilda Naimayer Padula'),
		   (10, 'Augusto Ruan Barbosa', '137.560.770-71', 'augustoruanbarbosa_@studiodeideias.com', '68982548839',
			'Rua Almirante Barbosa');
#=================================================================
...
INSERT INTO Cliente (id_cliente, nome, email, telefone, endereco)
	VALUES (1, 'Felipe Mário Renato Nogueira', 'felipemariorenatonogueira__felipemariorenatonogueira@citi.com',
		   ...
		   (4, 'Francisca Raimunda Elisa Duarte', 'ffranciscaraimundaelisaduarte@lojascentrodamoda.com.br',
			'47982580523',
		   ...
		   (8, 'Vicente Martin Martins"', 'vicentemartinmartins_@aerobravo.com.br', '85982562603',
			'Travessa João Pessoa'),
...
INSERT INTO Produto (id_produto, nome_prod, modelo, potencia, preco)
	VALUES (1, 'Modulo', 'SIW300H M010', 1, 10),
...
#=================================================================
INSERT INTO Obra (id_obra, data_inicial, prazo_estimado_dias, horas_trabalhadas)
	VALUES (1, '20201222', 90, 800),
		   (2, '20201213', 60, 400),
		   (3, '20201225', 90, 700),
		   (4, '20201202', 20, 100),
		   (5, '20201203', 90, 300),
		   ...
		   (10, '20200814', 90, 659);
#=================================================================
INSERT INTO Engenheiro_coordena_obra (id_engenheiro, id_obra)
	VALUES (1, 1),
		   (2, 2),
		   (3, 3),
		   (4, 4),
		   ...
		   (10, 10);
#=================================================================
INSERT INTO Proposta (id_proposta, id_associado, id_cliente, id_concessionaria, id_engenheiro, id_obra, valor_proposta,
					  geracao_desejada, id_unidade_geradora, endereco_instalacao, consumo_medio, tarifa, data_analise,
					  resultado, geracao_estimada)
	VALUES (1, 1, 1, 1, 1, 1, 321, 123, 1, 'Rua A', 23, 0.36, '20200611', 0, 31),
		   (2, 2, 2, 2, 2, 2, 789, 342, 2, 'Rua Pedro Artur', 53, 0.82, '20200612', 1, 42),
		   (3, 3, 3, 3, 3, 3, 678, 235, 3, 'Parque Gavião', 23, 0.32, '20200613', 1, 53),
		   (4, 4, 4, 4, 4, 4, 567, 636, 4, 'Rua José Targino de Castro', 35, 0.32, '20200615', 0, 35),
		   (5, 5, 5, 5, 5, 5, 456, 132, 5, 'Rua Nelson de Azevedo Souza', 46, 0.62, '20200608', 1, 46),
		   (6, 6, 6, 6, 6, 6, 345, 243, 6, 'Rua C', 23, 0.34, '20200612', 1, 57),
		   (7, 7, 7, 7, 7, 7, 234, 35, 7, 'Rua Jânio Lopes', 12, 0.32, '20200613', 1, 24),
		   (8, 8, 8, 8, 8, 8, 321, 123, 8, 'Alameda das Serras', 63, 0.75, '20200618', 1, 35),
		   (9, 9, 9, 9, 9, 9, 321, 6323, 9, 'Rua Professora Hilda Naimayer Padula', 24, 0.52, '20200618', 0, 46),
		   (10, 10, 10, 10, 10, 10, 523, 654, 10, 'Rua Almirante Barbosa', 21, 0.32, '20200618', 0, 57);
#=================================================================
